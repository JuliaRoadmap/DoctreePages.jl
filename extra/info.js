const __lang=`zh`
const buildmessage=`built at Fri Jan  6 12:48:18 2023 by DoctreePages.jl v1.7.0`
...
const menu=['',`welcome/README`,[`zh/中文文档`,`usage/使用方式`,`guidelines/规范`,`settings/设置`,`spec_codeblocks/特殊代码块`,`notice/注意事项`,`api/API 参考`,],[`en/English Docs`,`usage/Usage`,`guidelines/Guidelines`,`notice/Notice`,`settings/Settings`,],]
