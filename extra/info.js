const __lang=`zh`
const buildmessage=`built at Sun Jan 15 11:49:53 2023 by DoctreePages.jl v1.7.2`
const page_foot=`Powered by <a href='https://github.com/JuliaRoadmap/DoctreePages.jl'>DoctreePages.jl</a> and its dependencies.`
const tar_css=`css`
const menu=['',`welcome.html|README`,[`zh/index.html|中文文档`,`usage.html|使用方式`,`guidelines.html|规范`,`settings.html|设置`,`files.html|非设置文件`,`spec_codeblocks.html|特殊代码块`,`frame.html|标准单文档框架`,`api.html|API 参考`,],[`en/index.html|English Docs`,`usage.html|Usage`,`guidelines.html|Guidelines`,`notice.html|Notice`,`settings.html|Settings`,],]
