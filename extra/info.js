const __lang=`zh`
const buildmessage=`built at Sat Dec 24 05:10:27 2022 by DoctreePages.jl v1.6.1`
...
const menu=['',`welcome/README`,[`zh/中文文档`,`usage/使用方式`,`guidelines/规范`,`settings/设置`,`spec_codeblocks/特殊代码块`,`notice/注意事项`,],[`en/English Docs`,`usage/Usage`,`guidelines/Guidelines`,`notice/Notice`,`settings/Settings`,],]
