const __lang=`zh`
const buildmessage=`<p>built at Sun Jan 22 09:51:06 2023, by <a href='https://github.com/JuliaRoadmap/DoctreePages.jl'>DoctreePages.jl</a> v1.8.1</p>`
...
const menu=['',`welcome.html|README`,[`zh|中文文档`,`usage.html|使用方式`,`guidelines.html|规范`,`settings.html|设置`,`files.html|非设置文件`,`spec_codeblocks.html|特殊代码块`,`frame.html|标准单文档框架`,`api.html|API 参考`,],[`en|English Docs`,`usage.html|Usage`,`guidelines.html|Guidelines`,`notice.html|Notice`,`settings.html|Settings`,],]
